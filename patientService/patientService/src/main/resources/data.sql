...
--ALTER TABLE patient ADD COLUMN registered_date DATE DEFAULT CURRENT_DATE;

-- 2. Backfill existing rows (in case default doesn't apply retroactively)
UPDATE patient SET registered_date = CURRENT_DATE WHERE registered_date IS NULL;

-- 3. Set column to NOT NULL
ALTER TABLE patient ALTER COLUMN registered_date SET NOT NULL;
